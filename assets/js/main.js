...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var COOKIE_KEY = 'kwt_cookie_consent';
  ...
  var A11Y_KEY = 'kwt_a11y_settings';
  ...
  if (form) {
    ...
    form.addEventListener('submit', function (e) {
      ...
      fetch(endpoint, {
        ...
        .then(function (res) {
          if (res.ok) {
            msg.textContent = 'Dziękujemy! Twoje zapytanie zostało wysłane - odezwiemy się najszybciej, jak to możliwe.';
